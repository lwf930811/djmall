...
public class ShiroConfiguration {
    ...
    ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
        ...
        filters.put("/auth/user/toRegister", "anon");
        filters.put("/auth/user/insertUser", "anon");
        filters.put("/auth/user/toUpdatePassword", "anon");
        filters.put("/auth/user/findPassword", "anon");
        filters.put("/auth/user/sendMessage", "anon");
        filters.put("/auth/user/findPhonePassword", "anon");
        filters.put("/auth/user/getSalt", "anon");
        filters.put("/auth/user/updatePassword", "anon");
        // authc 表示必须认证才可访问
        filters.put("/**", "authc");
