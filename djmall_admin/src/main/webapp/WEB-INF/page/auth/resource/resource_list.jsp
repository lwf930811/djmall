...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $.post(
            "<%=request.getContextPath()%>/auth/resource/ResourceList",
            function (data) {
    ...
    function updateResource(value) {
        ...
        layer.open({
            ...
            titel: "修改",
            area: ["400px", "500px"],
            content: "<%=request.getContextPath()%>/auth/resource/toUpdate/"+value,
        });
    }
    ...
    function delResource() {
        ...
        layer.msg('确定删除?', {
            ...
            , yes: function () {
                $.post(
                    "<%=request.getContextPath() %>/auth/resource/delRoleResourceById/"+value,
                    {},
                    function (data) {
                        if (data.code == 200) {
                            layer.msg(data.msg, {
